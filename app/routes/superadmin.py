...
def superadmin_dashboard(user=Depends(require_roles(RoleEnum.SUPER_ADMIN)),db: Session = Depends(get_db)):
    """
...
def generate_superadmin_image(
    ...
    new_image = Image(
        ...
        status="ACCEPTED"  # SuperAdmin-generated images can be auto-accepted
    )
